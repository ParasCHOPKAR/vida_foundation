...
const cssdModules = [
  {
    title: "CSSD Overview & Layout",
    topics: [
      "Zoning: Dirty, Clean, Sterile areas",
      "Workflow design",
  ...
  {
    title: "Inspection, Assembly & Packing",
    topics: [
      "Instrument inspection methods",
      "Tray assembly protocols",
  ...
  {
    title: "Quality Control & Troubleshooting",
    topics: [
...
export default function CSSDCoursePage() {
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8">
            ...
            <h1 className="hero-element text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-[1.1] tracking-tight">
              CSSD & Sterilization <br className="hidden md:block" />
            ...
            <p className="hero-element text-lg md:text-xl text-blue-100/80 max-w-2xl mb-10 leading-relaxed font-light">
              Master the complete lifecycle of surgical instrument processing. Learn zoning, decontamination, advanced sterilization methods, and rigorous quality control.
            </p>
          ...
          <div className="hidden lg:block lg:col-span-4 hero-element">
            <div className="bg-white/10 backdrop-blur-2xl border border-white/20 p-8 rounded-3xl shadow-2xl relative overflow-hidden transform rotate-2 hover:rotate-0 transition-transform duration-500">
              ...
              <p className="text-blue-100/70 text-sm leading-relaxed mb-6">Equipping professionals with world-class CSSD operational standards and technical expertise.</p>
