...
const woundModules = [
  {
    ...
    topics: [
      "Stages of wound healing (Inflammatory, Proliferative, Maturation)",
      "Systemic and local factors affecting healing",
    ],
  },
  {
    title: "Wound Assessment",
    topics: [
      "Classification: Acute vs Chronic wounds",
      "Measurement techniques and clinical documentation protocols",
    ],
  },
  {
    title: "Dressing Techniques",
    topics: [
      "Selection of primary and secondary dressings",
      "Advanced wound products (Hydrocolloids, Alginates, Foams)",
    ],
  },
  {
    title: "Infection Control in Wounds",
    topics: [
      "Biofilm identification and management",
      "Antimicrobial therapies and topical agents",
    ],
  },
  {
    title: "Specialized Wound Care",
    topics: [
...
export default function AdvancedWoundManagementPage() {
    ...
    <div ref={containerRef} className="min-h-screen bg-[#F4F7FB] pb-24 selection:bg-[#F28500] selection:text-white font-sans">
      ...
      <div className="relative bg-[#021d38] text-white pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <Bandage className="absolute -bottom-20 right-10 w-[400px] h-[400px] text-white/5 rotate-12" strokeWidth={0.5} />
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="hero-element flex flex-wrap items-center gap-3 mb-6">
              <span className="bg-gradient-to-r from-[#F28500] to-[#ffab57] text-white text-[11px] font-black px-4 py-1.5 rounded-full uppercase tracking-[0.2em] shadow-[0_0_20px_rgba(242,133,0,0.4)] flex items-center gap-1.5">
                <Sparkles className="w-3.5 h-3.5" /> Advanced Certification
              </span>
            ...
            <h1 className="hero-element text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-[1.1] tracking-tight">
              Advanced Wound <br className="hidden md:block" />
            ...
            <p className="hero-element text-lg md:text-xl text-blue-100/80 max-w-2xl mb-10 leading-relaxed font-light">
              Deepen your expertise in wound healing physiology, infection control, and specialized dressing techniques to manage complex chronic conditions effectively.
            </p>
          ...
          <div className="hidden lg:block lg:col-span-4 hero-element">
            <div className="bg-white/10 backdrop-blur-2xl border border-white/20 p-8 rounded-3xl shadow-2xl relative overflow-hidden transform rotate-2 hover:rotate-0 transition-transform duration-500">
              ...
              <p className="text-blue-100/70 text-sm leading-relaxed mb-6">Comprehensive credential for specialists in chronic wound management and NPWT.</p>
        ...
        <div className="lg:col-span-4 space-y-8 relative lg:mt-6">
          <div className="sticky top-28 space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-[#021d38]">Practical Workshop</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-[#021d38]">Clinical Best Practices</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="sidebar-widget bg-white rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-slate-100 p-8">
              ...
              <ul className="space-y-3">
                {[
                  "Microscopic Wound Analysis",
                  "Dressing Application Labs",
                  "Biofilm Management Scenarios",
                  "Pressure Injury Prevention Drills",
                  "NPWT Equipment Setup"
                ].map((item, i) => (
            ...
            <div className="sidebar-widget group bg-[#021d38] rounded-3xl shadow-[0_20px_40px_rgba(2,29,56,0.3)] p-8 text-white text-center relative overflow-hidden cursor-pointer">
              ...
              <Microscope className="w-16 h-16 text-[#F28500] mx-auto mb-6 relative z-10 drop-shadow-lg group-hover:scale-110 transition-transform duration-500" />
              <h3 className="font-black text-2xl mb-3 relative z-10">Dressing Guide</h3>
              <p className="text-blue-100/70 mb-8 font-light text-sm leading-relaxed relative z-10">
                Download our comprehensive manual on matching wound types to advanced dressings.
              </p>
