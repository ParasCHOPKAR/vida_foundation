...
const ecgModules = [
  {
    ...
    topics: [
      "Cardiac conduction system (SA Node, AV Node, Purkinje fibers)",
      "ECG basics: Lead placement and paper interpretation",
    ],
  },
  {
    ...
    topics: [
      ...
      "Intervals and segments (PR, QRS, QT duration analysis)",
    ],
  },
  {
    title: "Arrhythmia Identification",
    topics: [
      "Bradyarrhythmias: Sinus Bradycardia, Heart Blocks",
      "Tachyarrhythmias: SVT, AFib, Atrial Flutter",
    ],
  },
  {
    title: "Ischemia & Infarction",
    topics: [
      "STEMI vs NSTEMI: Clinical differentiation",
      "ECG changes in Myocardial Infarction (ST elevation, T inversion)",
    ],
  },
  {
    title: "Emergency ECG Interpretation",
    topics: [
      "Life-threatening rhythms: V-Tach, V-Fib, Asystole",
      "Immediate nursing interventions and ACLS integration",
    ],
  },
];

export default function AdvancedECGPage() {
    ...
    <div ref={containerRef} className="min-h-screen bg-[#F4F7FB] pb-24 selection:bg-[#F28500] selection:text-white font-sans">
      ...
      <div className="relative bg-[#021d38] text-white pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <HeartPulse className="absolute -bottom-20 right-10 w-[400px] h-[400px] text-white/5 rotate-12" strokeWidth={0.5} />
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="hero-element flex flex-wrap items-center gap-3 mb-6">
              <span className="bg-gradient-to-r from-[#F28500] to-[#ffab57] text-white text-[11px] font-black px-4 py-1.5 rounded-full uppercase tracking-[0.2em] shadow-[0_0_20px_rgba(242,133,0,0.4)] flex items-center gap-1.5">
                <Zap className="w-3.5 h-3.5" /> Specialist Module
              </span>
            ...
            <h1 className="hero-element text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-[1.1] tracking-tight">
              Advanced ECG <br className="hidden md:block" />
            ...
            <p className="hero-element text-lg md:text-xl text-blue-100/80 max-w-2xl mb-10 leading-relaxed font-light">
              Master complex cardiac rhythms, infarction patterns, and life-saving diagnostic skills to provide high-level care in emergency and critical care settings.
            </p>
          ...
          <div className="hidden lg:block lg:col-span-4 hero-element">
            <div className="bg-white/10 backdrop-blur-2xl border border-white/20 p-8 rounded-3xl shadow-2xl relative overflow-hidden transform rotate-2 hover:rotate-0 transition-transform duration-500">
              ...
              <p className="text-blue-100/70 text-sm leading-relaxed mb-6">Expert-level credential in cardiac diagnostics for clinical nursing specialists.</p>
        ...
        <div className="lg:col-span-4 space-y-8 relative lg:mt-6">
          <div className="sticky top-28 space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-[#021d38]">Practical Hybrid</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-[#021d38]">Clinical Diagnostics</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="sidebar-widget bg-white rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-slate-100 p-8">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "STEMI Recognition Labs",
                  "Scenario-based Assessment",
                  "Interactive Waveform Drills",
                  "Advanced Interventions Workshop"
                ].map((item, i) => (
            ...
            <div className="sidebar-widget group bg-[#021d38] rounded-3xl shadow-[0_20px_40px_rgba(2,29,56,0.3)] p-8 text-white text-center relative overflow-hidden cursor-pointer">
              ...
              <HeartPulse className="w-16 h-16 text-[#F28500] mx-auto mb-6 relative z-10 drop-shadow-lg group-hover:scale-110 transition-transform duration-500" />
              <h3 className="font-black text-2xl mb-3 relative z-10">ECG Resource Kit</h3>
              <p className="text-blue-100/70 mb-8 font-light text-sm leading-relaxed relative z-10">
                Get our exclusive guide on recognizing 50+ cardiac rhythms and MI patterns.
              </p>
