...
const ipcModules = [
  {
    title: "Fundamentals of Infection Control",
    topics: [
      "Basics of microbiology (bacteria, viruses, fungi)",
      "Chain of infection",
  ...
  },
  {
    ...
    topics: [
      ...
      "Legal and regulatory requirements (India & global)",
    ],
  },
  {
...
export default function IPCCoursePage() {
  ...
  useGSAP(() => {
    ...
    // Cards Stagger (Slightly offset to start as hero finishes)
    gsap.fromTo(
      ".module-card",
      { y: 60, opacity: 0 },
      { 
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[#F4F7FB] pb-24 selection:bg-[#F28500] selection:text-white font-sans">
      ...
      {/* --- HERO SECTION (Ultra-Modern Aurora Effect) --- */}
      <div className="relative bg-[#021d38] text-white pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8">
            <Link href="/programs" className="hero-element inline-flex items-center gap-2 text-blue-200 hover:text-white mb-8 transition-all hover:-translate-x-2 font-medium text-sm bg-white/5 px-4 py-2 rounded-full border border-white/10 backdrop-blur-md w-fit">
            ...
            <p className="hero-element text-lg md:text-xl text-blue-100/80 max-w-2xl mb-10 leading-relaxed font-light">
              Master the core principles of hospital safety, outbreak investigation, and advanced sterilization to protect patients and healthcare workers globally.
            </p>
          ...
          {/* Right Hero Visual (Optional floating card) */}
          <div className="hidden lg:block lg:col-span-4 hero-element">
            <div className="bg-white/10 backdrop-blur-2xl border border-white/20 p-8 rounded-3xl shadow-2xl relative overflow-hidden transform rotate-2 hover:rotate-0 transition-transform duration-500">
              ...
              <p className="text-blue-100/70 text-sm leading-relaxed mb-6">Globally recognized credential aligning with international healthcare safety standards.</p>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-12 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
        ...
        {/* Left Column: Syllabus (Spans 8 columns) */}
        ...
        {/* Right Column: Sticky Sidebar (Spans 4 columns) */}
