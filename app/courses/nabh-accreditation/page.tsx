...
import { 
  ...
  Globe,
  MonitorPlay,
  ClipboardCheck // Icon for the Quality and Audit theme
} from "lucide-react";

// --- QUALITY & NABH SYLLABUS DATA ---
const qualityModules = [
  ...
  },
  {
    ...
    topics: [
      "Overview of NABH accreditation process",
...
export default function QualityNABHPage() {
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8">
            ...
            <h1 className="hero-element text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-[1.1] tracking-tight">
              Quality, NABH & <br className="hidden md:block" />
            ...
            <p className="hero-element text-lg md:text-xl text-blue-100/80 max-w-2xl mb-10 leading-relaxed font-light">
              Equip yourself with the tools to lead hospital audits, implement NABH standards, and drive patient safety goals to meet global clinical excellence benchmarks.
            </p>
          ...
          <div className="hidden lg:block lg:col-span-4 hero-element">
            <div className="bg-white/10 backdrop-blur-2xl border border-white/20 p-8 rounded-3xl shadow-2xl relative overflow-hidden transform rotate-2 hover:rotate-0 transition-transform duration-500">
              ...
              <ClipboardCheck className="w-16 h-16 text-[#F28500] mb-6 relative z-10" />
              <h3 className="text-2xl font-black text-white mb-2 relative z-10">Quality Standards</h3>
              <p className="text-blue-100/70 text-sm leading-relaxed mb-6 relative z-10">Implementing rigorous audit and risk management frameworks to achieve and maintain healthcare accreditation.</p>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-[#021d38]">10 Weeks</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
            ...
            <div className="sidebar-widget bg-white rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-slate-100 p-8">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "Gap Analysis Simulations",
                  "Interactive Accreditation Demos",
                  "RCA Scenarios & Audits",
