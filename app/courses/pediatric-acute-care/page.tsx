...
const paediatricModules = [
  {
    title: "Fundamentals of Child Growth & Development",
    topics: [
      "Principles of growth and development across Physical, Cognitive, Emotional, and Social domains",
      "Nature vs nurture concept in child development",
      "Developmental milestones (0–18 years) and growth charts/assessment tools",
    ],
  },
  {
    title: "Brain Development & Cognitive Growth",
    topics: [
      "Early brain development (0–5 years critical window) and neuroplasticity",
      "Language, memory development, and cognitive milestones",
      "Impact of environment and early stimulation",
    ],
  },
  {
    title: "Emotional & Psychological Development",
    topics: [
      "Attachment theory, bonding, and emotional regulation",
      "Temperament, personality development, and self-esteem building",
      "Understanding behavioral patterns and responses",
    ],
  },
  {
    title: "Infant & Toddler Development (0–3 Years)",
    topics: [
      "Feeding, sleep, and sensory/motor skills development",
      "Early communication, social cues, and parental bonding techniques",
      "Identifying red flags in early development",
    ],
  },
  {
    title: "Early Childhood Development (3–6 Years)",
    topics: [
      "School readiness, play-based learning, and peer relationships",
      "Managing tantrums, behavioral challenges, and fostering creativity",
    ],
  },
  {
    title: "School-Age Child Development (6–12 Years)",
    topics: [
      "Cognitive/academic development and emotional intelligence",
      "Behavioral discipline, peer pressure, and screen time management",
    ],
  },
  {
    title: "Adolescent Growth & Psychology (12–18 Years)",
    topics: [
      "Puberty, hormonal changes, and identity formation",
      "Mental health challenges (anxiety, depression) and risk behavior prevention",
  ...
  },
  {
    ...
    topics: [
      "Age-wise nutritional requirements and growth monitoring",
      "Immunization schedules, physical fitness, and common illnesses",
    ],
  },
  {
    title: "Developmental Disorders & Early Intervention",
    topics: [
      "Understanding Autism (ASD), ADHD, and Learning Disabilities",
      "Speech/developmental delays and early screening referral systems",
    ],
  },
  {
    title: "Child Mental Health & Well-being",
    topics: [
      "Managing stress/anxiety and building emotional resilience",
      "Bullying, cyber safety, sleep hygiene, and digital addiction prevention",
    ],
  },
  {
    title: "Parenting Skills & Family Dynamics",
    topics: [
      "Positive parenting techniques: Discipline vs punishment",
      "Building healthy communication and understanding family environment impact",
    ],
  },
  {
    title: "Role of Healthcare Professionals",
    topics: [
      "Developmental assessment in clinical practice and parent counseling",
      "Multidisciplinary approach, documentation, and community awareness",
    ],
  },
  {
    title: "Child Safety, Ethics & Legal Aspects",
    topics: [
      "Child protection, safeguarding, and recognizing abuse/neglect",
      "Legal frameworks (POCSO, child rights) and ethical pediatric care",
    ],
  },
];

export default function PaediatricGrowthPsychologyPage() {
    ...
    <div ref={containerRef} className="min-h-screen bg-[#F4F7FB] pb-24 selection:bg-[#F28500] selection:text-white font-sans">
      ...
      <div className="relative bg-[#021d38] text-white pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <Baby className="absolute -bottom-20 right-10 w-[400px] h-[400px] text-white/5 rotate-12" strokeWidth={0.5} />
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="hero-element flex flex-wrap items-center gap-3 mb-6">
              <span className="bg-gradient-to-r from-[#F28500] to-[#ffab57] text-white text-[11px] font-black px-4 py-1.5 rounded-full uppercase tracking-[0.2em] shadow-[0_0_20px_rgba(242,133,0,0.4)] flex items-center gap-1.5">
                <Sparkles className="w-3.5 h-3.5" /> Multidisciplinary Module
              </span>
            ...
            <h1 className="hero-element text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-[1.1] tracking-tight">
              Paediatric Mental & Physical <br className="hidden md:block" />
            ...
            <p className="hero-element text-lg md:text-xl text-blue-100/80 max-w-2xl mb-10 leading-relaxed font-light">
              A holistic framework of a child’s physical, cognitive, emotional, and psychological development from infancy through adolescence for healthcare professionals and parents.
            </p>
          ...
          <div className="hidden lg:block lg:col-span-4 hero-element">
            <div className="bg-white/10 backdrop-blur-2xl border border-white/20 p-8 rounded-3xl shadow-2xl relative overflow-hidden transform rotate-2 hover:rotate-0 transition-transform duration-500">
              ...
              <Award className="w-16 h-16 text-[#F28500] mb-6" />
              <h3 className="text-2xl font-black text-white mb-2">VIDA Certified</h3>
              <p className="text-blue-100/70 text-sm leading-relaxed mb-6">Comprehensive credential in pediatric growth, psychology, and early developmental intervention.</p>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-12 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
        ...
        <div className="lg:col-span-8 -mt-10 relative z-20">
          ...
          <div className="bg-white rounded-b-3xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] p-8 pt-6 space-y-6">
            {paediatricModules.map((module, index) => {
        ...
        <div className="lg:col-span-4 space-y-8 relative lg:mt-6">
          <div className="sticky top-28 space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-[#021d38]">16 Weeks</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">Scope</p>
                    <p className="font-bold text-[#021d38]">Developmental Psych</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="sidebar-widget bg-white rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-slate-100 p-8">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "Parent Counseling Roleplay",
                  "Neuroplasticity Workshops",
                  "Early Intervention Drills"
                ].map((item, i) => (
            ...
            <div className="sidebar-widget group bg-[#021d38] rounded-3xl shadow-[0_20px_40px_rgba(2,29,56,0.3)] p-8 text-white text-center relative overflow-hidden cursor-pointer">
              ...
              <Brain className="w-16 h-16 text-[#F28500] mx-auto mb-6 relative z-10 drop-shadow-lg group-hover:scale-110 transition-transform duration-500" />
              <h3 className="font-black text-2xl mb-3 relative z-10">Download Toolkit</h3>
              <p className="text-blue-100/70 mb-8 font-light text-sm leading-relaxed relative z-10">
                Get the complete syllabus, growth charts, and clinical assessment frameworks.
              </p>
