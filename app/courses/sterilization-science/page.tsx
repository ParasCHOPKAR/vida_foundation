...
import { 
  ...
  Globe,
  MonitorPlay,
  Microscope // Swapped in for the science theme!
} from "lucide-react";

// --- STERILIZATION SCIENCE SYLLABUS DATA ---
const sterilizationModules = [
  {
    title: "Principles of Sterilization Science",
    topics: [
      "Microbial death kinetics",
      "D-value, Z-value, F0 concept",
    ],
  },
  {
  ...
  {
    title: "Load Configuration & Cycle Design",
    topics: [
      "Load patterns",
      "Cycle parameters",
...
export default function SterilizationSciencePage() {
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8">
            ...
            <h1 className="hero-element text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-[1.1] tracking-tight">
              Sterilization Science <br className="hidden md:block" />
            ...
            <p className="hero-element text-lg md:text-xl text-blue-100/80 max-w-2xl mb-10 leading-relaxed font-light">
              Master the deep science behind microbial death kinetics, D-values, and comprehensive equipment qualification (IQ, OQ, PQ) to ensure flawless sterilization cycles.
            </p>
          ...
          <div className="hidden lg:block lg:col-span-4 hero-element">
            <div className="bg-white/10 backdrop-blur-2xl border border-white/20 p-8 rounded-3xl shadow-2xl relative overflow-hidden transform rotate-2 hover:rotate-0 transition-transform duration-500">
              ...
              <Microscope className="w-16 h-16 text-[#F28500] mb-6 relative z-10" />
              <h3 className="text-2xl font-black text-white mb-2 relative z-10">Scientific Rigor</h3>
              <p className="text-blue-100/70 text-sm leading-relaxed mb-6 relative z-10">Dive deep into the mathematics and microbiology that guarantee absolute sterility assurance in clinical environments.</p>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-12 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
        ...
        <div className="lg:col-span-8 -mt-10 relative z-20">
          ...
          <div className="bg-white rounded-b-3xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] p-8 pt-6 space-y-6">
            {sterilizationModules.map((module, index) => {
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-[#021d38]">8 Weeks</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
