...
import { 
  ...
  Globe,
  MonitorPlay,
  Droplets // Icon for the hygiene/cleaning theme
} from "lucide-react";

// --- HOSPITAL HYGIENE SYLLABUS DATA ---
const hygieneModules = [
  {
    title: "Principles of Hospital Cleaning",
    topics: [
  ...
  {
    title: "Area-wise Cleaning Protocols",
    topics: [
      "ICU, OT, Wards, and OPD protocols",
      "Terminal cleaning procedures",
    ],
  },
  {
    title: "Disinfectants & Chemicals",
    topics: [
      "Types and selection of chemicals",
      "Contact time & dilution ratios",
    ],
  },
  {
    title: "Air Quality & Infection Control",
    topics: [
      "HVAC system basics",
      "HEPA filters management",
      "Airborne infection control protocols",
    ],
  },
];

export default function HospitalHygienePage() {
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="hero-element flex flex-wrap items-center gap-3 mb-6">
              <span className="bg-gradient-to-r from-[#F28500] to-[#ffab57] text-white text-[11px] font-black px-4 py-1.5 rounded-full uppercase tracking-[0.2em] shadow-[0_0_20px_rgba(242,133,0,0.4)] flex items-center gap-1.5">
                <Sparkles className="w-3.5 h-3.5" /> Core Certification
              </span>
            ...
            <h1 className="hero-element text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-[1.1] tracking-tight">
              Hospital Hygiene & <br className="hidden md:block" />
            ...
            <p className="hero-element text-lg md:text-xl text-blue-100/80 max-w-2xl mb-10 leading-relaxed font-light">
              Master the protocols for critical area cleaning, chemical selection, and air quality management to maintain a flawless, infection-free healthcare environment.
            </p>
          ...
          <div className="hidden lg:block lg:col-span-4 hero-element">
            <div className="bg-white/10 backdrop-blur-2xl border border-white/20 p-8 rounded-3xl shadow-2xl relative overflow-hidden transform rotate-2 hover:rotate-0 transition-transform duration-500">
              ...
              <Droplets className="w-16 h-16 text-[#F28500] mb-6 relative z-10" />
              <h3 className="text-2xl font-black text-white mb-2 relative z-10">Environmental Safety</h3>
              <p className="text-blue-100/70 text-sm leading-relaxed mb-6 relative z-10">Learn risk-based cleaning and disinfection techniques to eliminate HAIs at the source.</p>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-12 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
        ...
        <div className="lg:col-span-8 -mt-10 relative z-20">
          ...
          <div className="bg-white rounded-b-3xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] p-8 pt-6 space-y-6">
            {hygieneModules.map((module, index) => {
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-[#021d38]">6 Weeks</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
