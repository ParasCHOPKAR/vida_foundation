...
import { 
  ...
  Globe,
  MonitorPlay,
  HeartPulse // Icon for the nursing/vital signs theme
} from "lucide-react";

// --- NURSING SKILL DEVELOPMENT SYLLABUS DATA ---
const nursingSkillsModules = [
  {
  ...
  {
    title: "ICU & OT Assistance",
    topics: [
      "ICU protocols",
      "Surgical assistance basics",
    ],
  },
  {
...
export default function NursingSkillDevelopmentPage() {
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8">
            ...
            <h1 className="hero-element text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-[1.1] tracking-tight">
              Paramedical & Nursing <br className="hidden md:block" />
            ...
            <p className="hero-element text-lg md:text-xl text-blue-100/80 max-w-2xl mb-10 leading-relaxed font-light">
              Master essential bedside care, emergency life support (BLS/CPR), and critical ICU/OT protocols to deliver compassionate, high-quality patient care.
            </p>
          ...
          <div className="hidden lg:block lg:col-span-4 hero-element">
            <div className="bg-white/10 backdrop-blur-2xl border border-white/20 p-8 rounded-3xl shadow-2xl relative overflow-hidden transform rotate-2 hover:rotate-0 transition-transform duration-500">
              ...
              <HeartPulse className="w-16 h-16 text-[#F28500] mb-6 relative z-10" />
              <h3 className="text-2xl font-black text-white mb-2 relative z-10">Clinical Excellence</h3>
              <p className="text-blue-100/70 text-sm leading-relaxed mb-6 relative z-10">Hands-on skill development aligning with international nursing, communication, and paramedical standards.</p>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-12 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
        ...
        <div className="lg:col-span-8 -mt-10 relative z-20">
          ...
          <div className="bg-white rounded-b-3xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] p-8 pt-6 space-y-6">
            {nursingSkillsModules.map((module, index) => {
            ...
            <div className="sidebar-widget bg-white rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-slate-100 p-8">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "BLS & CPR Manikin Practice",
                  "ICU Protocol Simulations",
