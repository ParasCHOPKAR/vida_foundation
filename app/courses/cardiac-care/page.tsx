...
const cardiacModules = [
  {
    title: "Cardiovascular System Overview",
    topics: [
      "Advanced anatomy & physiology of the heart",
      "Principles of hemodynamics and blood flow",
      "Cardiac cycle and pressure-volume relationships",
    ],
  },
  {
    title: "Common Cardiac Conditions",
    topics: [
      "Pathophysiology and management of Heart Failure",
      "Acute Coronary Syndrome (ACS) protocols",
      "Valvular heart diseases and Cardiomyopathies",
    ],
  },
  {
    title: "Cardiac Monitoring",
    topics: [
      "Advanced ECG monitoring and rhythm analysis",
      "Invasive hemodynamic monitoring (Art-lines, CVP)",
      "Interpretation of cardiac output and stroke volume",
    ],
  },
  {
    title: "Cardiac Interventions",
    topics: [
      "Emergency drug therapy (Inotropes, Vasopressors)",
      "Post-operative care for cardiac surgery patients",
      "Management of pacemakers and ICDs",
    ],
  },
  {
    title: "Patient Education & Rehabilitation",
    topics: [
      "Lifestyle modification and risk factor reduction",
      "Phases of Cardiac Rehabilitation",
      "Patient counseling for chronic heart condition management",
    ],
  },
];
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8">
            ...
            <h1 className="hero-element text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-[1.1] tracking-tight">
              Cardiac Care <br className="hidden md:block" />
            ...
            <p className="hero-element text-lg md:text-xl text-blue-100/80 max-w-2xl mb-10 leading-relaxed font-light">
              Master hemodynamics, advanced cardiac monitoring, and post-operative interventions to provide life-saving care to patients with complex cardiovascular conditions.
            </p>
          ...
          <div className="hidden lg:block lg:col-span-4 hero-element">
            <div className="bg-white/10 backdrop-blur-2xl border border-white/20 p-8 rounded-3xl shadow-2xl relative overflow-hidden transform rotate-2 hover:rotate-0 transition-transform duration-500">
              ...
              <Activity className="w-16 h-16 text-[#F28500] mb-6" />
              <h3 className="text-2xl font-black text-white mb-2">VIDA Certified</h3>
              <p className="text-blue-100/70 text-sm leading-relaxed mb-6">Expert-level credential focusing on advanced hemodynamic stability and recovery.</p>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-12 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
        ...
        <div className="lg:col-span-8 -mt-10 relative z-20">
          ...
          <div className="bg-white rounded-b-3xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] p-8 pt-6 space-y-6">
            {cardiacModules.map((module, index) => {
        ...
        <div className="lg:col-span-4 space-y-8 relative lg:mt-6">
          <div className="sticky top-28 space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-[#021d38]">Cardiac Rehab Focus</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="sidebar-widget bg-white rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-slate-100 p-8">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "ECG Rhythm Analysis Labs",
                  "ACS Management Drills",
                  "Rehab Counseling Scenarios",
            ...
            <div className="sidebar-widget group bg-[#021d38] rounded-3xl shadow-[0_20px_40px_rgba(2,29,56,0.3)] p-8 text-white text-center relative overflow-hidden cursor-pointer">
              ...
              <h3 className="font-black text-2xl mb-3 relative z-10">Cardiac Care PDF</h3>
              <p className="text-blue-100/70 mb-8 font-light text-sm leading-relaxed relative z-10">
                Download the complete handbook on cardiac condition management and rehabilitation.
              </p>
